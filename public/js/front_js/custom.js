(function ($) {
    ...
    $.fn.floatingWhatsApp = function (options) {
        ...
        if (settings.showPopup) {
            ...
            $($textarea).attr("placeholder", "Escribí tu mensaje aquí...");
    ...
    $(function() {
        $('#myButtonWhatsApp').floatingWhatsApp({
            ...
            showPopup: true,
            showOnIE: false,
            headerTitle: 'Hola! estoy para ayudarte...',
            headerColor: '#74c586',
            backgroundColor: '',
    ...
    */
            ...
            $("#responseContacto").html(
                "<div style='text-align:center'><img class='loading-contact-logo' src='" +
                    baseUrl +
                    "/images/logo.png'><br><img class='loading-contact-loading' src='" +
                    baseUrl +
