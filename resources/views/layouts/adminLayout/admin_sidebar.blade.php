            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-calendar"></i> Fechas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('/admin/carga-masiva') }}">Carga masiva</a></li>
                      <li><a href="{{ url('/admin/eliminar-fechas') }}">Eliminar fechas</a></li>
                      <li><a href="{{ url('/admin/view-fechas') }}">Ver fechas</a></li>
                    </ul>
                  </li>

                  <li><a><i class="fa fa-building"></i> Apartamentos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('/admin/add-apartamento') }}">Nuevo apartamento</a></li>
                      <li><a href="{{ url('/admin/view-apartamentos') }}">Listado</a></li>
                    </ul>
                  </li>
